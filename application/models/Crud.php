...
class Crud extends CI_Model
{
    ...
    public function get_where_select_not_in($table, $select, $where, $notin)
    {
        $this->db->select($select);
        $this->db->order_by("id", "DESC");
        $this->db->where_not_in('no_absen', $notin);
        return $this->db->get_where($table, $where);
    }

    public function get_where_between($table, $where, $minvalue, $maxvalue)
    {
        $this->db->where("$where BETWEEN '$minvalue' AND '$maxvalue'");
        $this->db->order_by("id", "DESC");
        return $this->db->get($table);
    }
    ...
    public function sum($table, $select)
    {
        $this->db->select_sum($select);
        return $this->db->get($table);
    }
