                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="<?= base_url() ?>" class="app-brand-link gap-2">
                                ...
                                <img src="<?= base_url('assets/assets/img/logo.png') ?>" alt="logo" class="img-fluid" style="max-width: 100px;">
                                </span>
                                <!-- <span class="app-brand-text demo text-body fw-bold ms-1">Sienna</span> -->
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Selamat datang kembali</h4>
                        ...
                        <form class="mb-3" action="<?= base_url('auth') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" name="login" id="login">Sign in</button>
                            </div>
                        </form>
