                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="<?= base_url() ?>" class="app-brand-link gap-2">
                                ...
                                <!-- <span class="app-brand-text demo text-body fw-bold">Sienna</span> -->
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Lupa password Anda?</h4>
                        <p class="mb-4">Masukkan akun email Anda dibawah ini, kami akan mengirimkan email beserta tautan untuk reset password Anda.</p>
                        <form class="mb-3" action="<?= base_url('auth/cekmail') ?>" method="POST">
                            <div class="mb-3">
